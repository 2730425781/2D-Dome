...
public class AttackDate
{
    ...
    public ElementalEffectDate effectDate;

    public AttackDate(Entity_Stats stats, DamageScaleDate damageScale)
    {
        ...
        effectDate = new ElementalEffectDate(stats, damageScale);
    }
}
