...
<!-- Funplay Unity MCP project skill versions: unity-mcp-workflow@1.0.3, unity-ui-composition@1.0.1 -->
...
- `funplay-unity-ui-composition` v1.0.1 - Build and revise responsive Unity uGUI mobile interfaces, including portrait and landscape layouts, safe areas, prefabs, auto layout, scrolling, text, input, animation, and performance validation.
...
- Project root: `D:\unity\Unity project\2D_Projects\Udemy Course-RPG New`
- Product name: `Udemy Course-RPG New`
